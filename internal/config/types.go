...
type MonitoringConfig struct {
	...
	ForensicsOnKill           *bool               `toml:"forensics_on_kill"`            // Copy the container for forensics before an auto-kill deletes it (default: true)
...
// the audit log. Set false to skip the copy (plain stop-and-delete kill).
func (m *MonitoringConfig) IsForensicsOnKillEnabled() bool {
	if m == nil || m.ForensicsOnKill == nil {
		return true
	}
	return *m.ForensicsOnKill
}
